...
module JsAPI
  ...
  class JSExtendedClass < FFI::Struct
    layout(
           ...
           :reserved0, callback(:reserved0, [  ], :void),
           :reserved1, callback(:reserved1, [  ], :void),
           :reserved2, callback(:reserved2, [  ], :void),
           :reserved3, callback(:reserved3, [  ], :void),
           :reserved4, callback(:reserved4, [  ], :void)
    )
  end
  ...
  class JSPrincipals < FFI::Struct
    layout(
           :codebase, :string,
           :getPrincipalArray, callback(:getPrincipalArray, [ :pointer, :pointer ], :pointer),
           :globalPrivilegesEnabled, callback(:globalPrivilegesEnabled, [ :pointer, :pointer ], :int),
           :refcount, :int,
           :destroy, callback(:destroy, [ :pointer, :pointer ], :void),
           :subsume, callback(:subsume, [ :pointer, :pointer ], :int)
    )
  end
